          ...
          <AppBar position="static" className={classes.MuiAppBar}>
            ...
            >
              ...
              <Grid item xs={10}>
                ...
                >
                  <Grid item xs={1.5}>
                    <Link className={classes.link} to="/login/trainee">
                      <Button className={classes.button}>TRAINEE</Button>
                    </Link>
                  </Grid>
                  <Grid item xs={1.5}>
                    <Link className={classes.link} to="/login/textfield-demo">
                      <Button className={classes.button}>TEXTFIELD DEMO</Button>
                    </Link>
                  </Grid>
                  <Grid item xs={1.5}>
                    <Link className={classes.link} to="/login/input-demo">
                      <Button className={classes.button}>INPUT DEMO</Button>
                    </Link>
                  </Grid>
                  <Grid item xs={1.5}>
                    <Link className={classes.link} to="/login/form-validation-demo">
                      <Button className={classes.button}>FORM VALIDATION DEMO</Button>
                    </Link>
                  </Grid>
                  <Grid item xs={1.5}>
                    <Link className={classes.link} to="/login/children-demo">
                      <Button className={classes.button}>CHILDREN DEMO</Button>
                    </Link>
                  </Grid>
                  <Grid item xs={1.5}>
                    <Link className={classes.link} to="/login/basic-slider-demo">
                      <Button className={classes.button}>BASIC SLIDER DEMO</Button>
                    </Link>
                  </Grid>
                  <Grid item xs={1.5}>
                    <Link className={classes.link} to="/login/logout">
